...
namespace Vonk.Plugin.PreferredIdOperation.Tests.Helpers
{
    public class VonkTestContext : VonkBaseContext, IVonkContext
    {
        ...
        public VonkTestContext(VonkInteraction interaction, string informationModel = VonkConstants.Model.FhirR4) : this(informationModel)
        {
            TestRequest.Interaction = interaction;
            TestResponse.Payload = this.Response.Payload;
        }
